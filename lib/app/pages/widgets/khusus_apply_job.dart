...
class KhususApplyJob extends StatefulWidget {
  // final int currentTab;

  const KhususApplyJob({
    Key? key,
    // required this.currentTab,
  });

  @override
  State<KhususApplyJob> createState() => _KhususApplyJobState();
}

class _KhususApplyJobState extends State<KhususApplyJob> {
  int selectedIndex = 2;
